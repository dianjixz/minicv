                      ...
                      uint32_t threshold, unsigned int theta_margin, unsigned int rho_margin)
{
    ...
    for (int y = 1, yy = r_size - 1; y < yy; y++)
    {
        ...
        {
            if ((row_ptr[x] >= threshold) && (row_ptr[x] >= row_ptr[x - theta_size - 1]) && (row_ptr[x] >= row_ptr[x - theta_size]) && (row_ptr[x] >= row_ptr[x - theta_size + 1]) && (row_ptr[x] >= row_ptr[x - 1]) && (row_ptr[x] >= row_ptr[x + 1]) && (row_ptr[x] >= row_ptr[x + theta_size - 1]) && (row_ptr[x] >= row_ptr[x + theta_size]) && (row_ptr[x] >= row_ptr[x + theta_size + 1]))
            {
                        ...
                        unsigned int r_min, unsigned int r_max, unsigned int r_step)
{
    ...
    {                                         // ignore r = 0/1
        ...
        for (int y = 1, yy = b_size - 1; y < yy; y++)
        {
            ...
            {
                if ((row_ptr[x] >= threshold) && (row_ptr[x] >= row_ptr[x - a_size - 1]) && (row_ptr[x] >= row_ptr[x - a_size]) && (row_ptr[x] >= row_ptr[x - a_size + 1]) && (row_ptr[x] >= row_ptr[x - 1]) && (row_ptr[x] >= row_ptr[x + 1]) && (row_ptr[x] >= row_ptr[x + a_size - 1]) && (row_ptr[x] >= row_ptr[x + a_size]) && (row_ptr[x] >= row_ptr[x + a_size + 1]))
                {
