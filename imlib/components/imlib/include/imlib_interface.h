...
#define COLOR_BAYER_TO_RGB888(img, x, y, r, g, b)                    \
    (                                                                \
        {                                                            \
            __typeof__(x) __x = (x);                                 \
            __typeof__(y) __y = (y);                                 \
...
#define COLOR_RGB565_TO_RGB888(pixel)                                                                                        \
    (                                                                                                                        \
        {                                                                                                                    \
            ...
            COLOR_R8_G8_B8_TO_RGB888(COLOR_RGB565_TO_R8(__pixel), COLOR_RGB565_TO_G8(__pixel), COLOR_RGB565_TO_B8(__pixel)); \
        })
...
#define IMAGE_GET_RGB888_PIXEL(image, x, y)                               \
    (                                                                     \
        {                                                                 \
            ...
            __typeof__(x) _x = (x);                                       \
            __typeof__(y) _y = (y);                                       \
            uint8_t *_pixel = _image->data + _image->w * _y * 3 + _x * 3; \
            COLOR_R8_G8_B8_TO_RGB888(_pixel[0], _pixel[1], _pixel[2]);    \
        })
